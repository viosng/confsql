...
public class ThriftExpression implements org.apache.thrift.TBase<ThriftExpression, ThriftExpression._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftExpression> {
  ...
  /**
   * 
   * @see com.viosng.confsql.semantic.model.thrift.ThriftExpressionType
   */
  public ThriftExpressionType type; // required
  /**
   *
   * @see com.viosng.confsql.semantic.model.thrift.ThriftQueryType
   */
  ...
  public List<ThriftParameter> parameters; // optional
  ...
  public ThriftExpression(ThriftExpression other) {
    ...
    if (other.isSetParameters()) {
      List<ThriftParameter> __this__parameters = new ArrayList<ThriftParameter>(other.parameters.size());
  ...
  public void addToParameters(ThriftParameter elem) {
    if (this.parameters == null) {
      this.parameters = new ArrayList<ThriftParameter>();
    }
    this.parameters.add(elem);
  }

  public List<ThriftParameter> getParameters() {
    return this.parameters;
  }

  public ThriftExpression setParameters(List<ThriftParameter> parameters) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PARAMETERS:
      if (value == null) {
        ...
        setParameters((List<ThriftParameter>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.parameters = new ArrayList<ThriftParameter>(_list3.size);
                ThriftParameter _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = new ThriftParameter();
                  _elem4.read(iprot);
      ...
      if (struct.parameters != null) {
        if (struct.isSetParameters()) {
          oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
          {
            ...
            for (ThriftParameter _iter10 : struct.parameters)
            {
              _iter10.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (ThriftParameter _iter13 : struct.parameters)
          {
            _iter13.write(oprot);
          }
        }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.parameters = new ArrayList<ThriftParameter>(_list18.size);
          ThriftParameter _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = new ThriftParameter();
            _elem19.read(iprot);
